...
import { SelectTrigger, SelectItem, SelectValue, Select, SelectContent } from "./ui/select";
...
const CreateAccountDrawer = ({ children }) => {
    ...
    return (
        <Drawer open={open} onOpenChange={setOpen}> {/* ✅ Corrected the prop name */}
                ...
                <div className="px-4 pb-4">
                    <form className="space-y-4" onSubmit={handleSubmit(onSubmit)}>
                        <div className="space-y-2">
                            ...
                            <Input id="name" placeholder="e.g., Main Checking"  {...register("name")}></Input>
                        ...
                        <div className="space-y-2">
                            ...
                            <Select onValueChange={(value) => setValue("type", value)}
                                defaultValue={watch("type")} className=""
                            >
                                ...
                                <SelectContent>
                                    <SelectItem value="CURRENT">Currents</SelectItem>
                        ...
                        <div className="space-y-2">
                            ...
                            <Input id="balance" type="number" step="0.01" placeholder="0.00"  {...register("balance")}></Input>
